                    ...
                    <table id="customCountryTable" class="table border-top display">
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $state = '';
                                if (trim($country->country_status) == 'Whitelist') {
                                    $state = 'success';
                                } elseif (trim($country->country_status) == 'GreyList') {
                                    $state = 'primary';
                                } elseif (trim($country->country_status) == 'BlackList') {
                                    $state = 'danger';
                                } 
                            ...
                            <tr>
                                ...
                                {{-- Display country status with badge --}}
                                <td>
